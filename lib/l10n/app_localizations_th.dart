...
class AppLocalizationsTh extends AppLocalizations {
  ...
  @override
  String get themeToggleToNier => 'สลับไปธีม NieR';

  @override
  String get themeToggleToDark => 'สลับไปธีมมืด';
  ...
  String get performanceCardNote =>
      'สองตัวเลือกแรกช่วยได้เฉพาะเมื่อ CPU เป็นคอขวด หาก CPU ของคุณช้ากว่า GPU การเปิดทั้งคู่อาจเพิ่มประสิทธิภาพได้สูงสุด 20% ส่วนบนระบบที่ GPU เป็นคอขวดจะไม่มีอะไรเปลี่ยนแปลง ตัวเลือกที่สามเกี่ยวกับอาการกระตุกขณะโหลดแผนที่ ไม่ใช่อัตราเฟรม';
  ...
  String get namsDescription =>
      'NAMS คือ mod loader ที่โฮสต์ NieR:Automata โดยจะเปิดเกมภายในโปรเซสของตัวเอง โหลดม็อดของคุณขณะรันไทม์ และใช้การตั้งค่าเอนจินเหล่านี้ ตัวเลือกเหล่านี้ควบคุมการตรวจสอบ ฟีเจอร์เนื้อหา การโหลดปลั๊กอิน/ReShade/3DMigoto และขนาดหน่วยความจำ heap';

  @override
  String get yorhaProtocolDescription =>
      'YP Devkit (YorHa Protocol) คือปลั๊กอินสำหรับมอดและนักพัฒนาที่โหลดโดย NAMS ชุดเครื่องมือทั้งหมด — ตัวแสดงฮิตบ็อกซ์/แสง/กระดูก, กล้องอิสระและโหมดถ่ายภาพ, การสร้างเอนทิตี, ต้นไม้สคริปต์ HAP, ตัวสร้างไอเทม และอื่น ๆ — อยู่ในโอเวอร์เลย์ในเกมที่เปิดด้วยปุ่ม F1 แท็บนี้เป็นที่สะดวกสำหรับปรับปุ่มลัด สวิตช์พื้นที่ทำงาน สูตรโกง และตัวสุ่มศัตรูจากตัวเรียกใช้งาน ซึ่งทั้งหมดนี้ยังเปลี่ยนได้ในเกมด้วย';
  ...
  @override
  String get subheadingMsaaPerformance => 'แก้ประสิทธิภาพ MSAA (ทดลอง)';

  @override
  String get labelMsaaPerPixel => 'เชดวัสดุต่อพิกเซล';

  @override
  String get tooltipMsaaPerPixel =>
      'เมื่อเปิดแอนตี้เอเลียสของเกม (MSAA) เกมจะเชดวัสดุแต่ละชิ้นหนึ่งครั้งต่อแซมเปิล ที่ 8x MSAA จึงเชดทุกโมเดลแปดครั้ง เปิดตัวเลือกนี้แล้ววัสดุจะเชดหนึ่งครั้งต่อพิกเซล และ MSAA จะทำหน้าที่ลบรอยหยักที่ขอบเท่านั้น ต้องเปิดแก้ขอบสว่าง MSAA มีผลทันที';

  @override
  String get labelMsaaPerPixelTerrain => 'รวมวัสดุพื้นดินด้วย';

  @override
  String get tooltipMsaaPerPixelTerrain =>
      'ส่วนที่ได้ประสิทธิภาพมากที่สุด พื้นเปียกอาจกะพริบสว่างชั่วครู่ แรงกว่าปกติ ถ้าไม่รบกวน นี่คือประสิทธิภาพ MSAA ที่ได้มากที่สุด มีผลทันที';
  ...
  String get labelConstantBufferUploadOnBind =>
      'อัปโหลดพารามิเตอร์เชเดอร์เฉพาะตอนวาด';

  @override
  String get tooltipConstantBufferUploadOnBind =>
      'เพิ่มประสิทธิภาพ เกมต้นฉบับส่งบล็อกพารามิเตอร์เชเดอร์ทุกบล็อกไปยังการ์ดจอทุกเฟรม รวมถึงบล็อกที่ไม่มีอะไรบนหน้าจอใช้ ซึ่งมีประมาณสี่ในห้า เมื่อเปิดใช้งาน บล็อกจะถูกส่งเฉพาะเมื่อการวาดผูกใช้งานจริง มีผลทันที';

  @override
  String get labelDecreaseStutterDuringGridLoading =>
      'ลดอาการกระตุกขณะโหลดแผนที่';

  @override
  String get tooltipDecreaseStutterDuringGridLoading =>
      'ทำให้การโหลดแผนที่ลื่นขึ้น เมื่อส่วนใหม่ของแผนที่โหลดรอบตัวคุณ เกมต้นฉบับจะสร้างทุกอย่างของส่วนนั้นในคราวเดียว ทำให้กระตุกทุกครั้ง เมื่อเปิดใช้งาน งานนั้นจะถูกกระจายไปหลายเฟรมและเตรียมไว้ล่วงหน้าในพื้นหลัง อาการกระตุกส่วนใหญ่จึงหายไป อยู่ระหว่างพัฒนา จะมีการปรับปรุงเพิ่มเติมในอัปเดตถัดไป คุณจะยังรู้สึกกระตุกเล็กน้อยเป็นครั้งคราวขณะแผนที่โหลด เช่น ตอนที่เอฟเฟกต์หรือวัตถุใหม่ปรากฏ อย่าคาดหวังอัตราเฟรมที่สูงขึ้น การโหลดที่เร็วขึ้น หรือการโหลดที่ไม่กระตุกเลยเมื่อใช้แพ็กเท็กซ์เจอร์ 4K มีผลทันที';
